  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-md transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-11/12 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-lg",
        right:
          "inset-y-0 right-0 h-full w-11/12 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-xl rounded-tl-3xl rounded-bl-3xl",
      },
    },
    defaultVariants: {
      side: "right",
